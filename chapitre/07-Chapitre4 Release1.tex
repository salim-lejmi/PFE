...
\hline
\endhead 
Authentification & En tant qu'utilisateur, je veux m'authentifier avec une adresse e-mail unique pour accéder à mes fonctionnalités & Élevée \\
\hline
Récupération de compte & En tant qu'utilisateur, je veux récupérer mon compte en cas d'oubli de mot de passe & Élevée \\
\hline
...
\begin{figure}[H]
    \centering
    \includegraphics[width=12cm,height=8cm]{images/authuc.png}
...
& - Mot de passe oublié : l'utilisateur saisit son email, le système génère un token, envoie un email de réinitialisation, l'utilisateur clique sur le lien, saisit un nouveau mot de passe, le système met à jour le mot de passe \\
\hline
\end{longtable}
...
& 8. Le système crée l'entreprise \\
...
\begin{figure}[H]
    \centering
    \includegraphics[width=11cm,height=6cm]{images/profileuc.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=11cm,height=8.5cm]{images/authentifiaction.png}
    \caption{Diagramme de séquence pour le scénario d'authentification}
\end{figure}
\subsubsection{Diagramme de séquence pour le scénario de récupération de compte}
\begin{figure}[H] 
    \centering
    \includegraphics[width=11cm,height=8.5cm]{images/recuperationseq.png}
    \caption{Diagramme de séquence pour le scénario de récupération de compte}
\end{figure}
\subsubsection{Diagramme de séquence pour le scénario d'inscription}
\begin{figure}[H]
    \centering
    \includegraphics[width=11cm,height=9cm]{images/inscription.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=11cm,height=9.5cm]{images/profilseq.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=16cm,height=10cm]{images/authpic.jpg}
...
\end{figure}
\subsubsection{Interface de récupération de mot de passe}
\noindent La figure 4.X présente l'interface de récupération de mot de passe permettant aux utilisateurs de réinitialiser leur mot de passe.

\begin{figure}[H]
    \centering
    \includegraphics[width=15cm,height=8cm]{images/recuperation.jpg}
...
\section{Sprint 2 : Gestion des utilisateurs, entreprises et taxonomie}
...
\begin{figure}[H] 
    \centering
    \includegraphics[width=17cm,height=10cm]{images/gestionuseruc.png}
...
\noindent La figure 4.14 présente le diagramme de cas d'utilisation détaillé pour la gestion des entreprises par le Super Admin et l'Admin. 
...
\hline
\textbf{Postcondition} & Entreprises consultées, modifiées ou supprimées selon l'action et le rôle \\
\hline
\textbf{Scénario nominal} & 
\textit{Super Admin :} \\
...
& \\
& \textit{Admin :} \\
& 1. L'Admin accède à la page des paramètres de son entreprise \\
...
& 5. Le système valide et met à jour les informations \\
& 6. Le système affiche un message de confirmation \\
\hline
\textbf{Scénario alternatif} & 
- Suppression (Super Admin) : vérification des données associées \\
