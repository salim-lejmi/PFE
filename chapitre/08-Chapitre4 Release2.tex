...
\hline
Optimiser les plans d'abonnement & En tant que Super Admin, je peux consulter et appliquer les suggestions d'optimisation de plans & Faible \\
\hline
...
\hline
\textbf{Postcondition} & Plans d'abonnement créés, modifiés, supprimés, désactivés ou optimisés selon l'action \\
\hline
\textbf{Scénario nominal} & 
1. Le Super Admin accède à la page de gestion des plans d'abonnement \\
& 2. Le système affiche la liste des plans existants \\
& 3. Le Super Admin sélectionne une action (créer, modifier, supprimer, désactiver, optimiser) \\
...
& - Optimisation : analyse NLP des performances et suggestions d'amélioration \\
...
\begin{figure}[H] 
    \centering 
    \includegraphics[width=14cm,height=8cm]{images/textsuc.png}
...
\begin{figure}[H] 
    \centering
    \includegraphics[width=15cm,height=9cm]{images/complianceuc.png}
...
\begin{figure}[H] 
    \centering
    \includegraphics[width=16cm,height=10cm]{images/actionplansuc.png}
...
\end{figure}
\subsubsection{Diagramme de séquence pour le scénario d'optimisation des plans d'abonnement}
\begin{figure}[H]
    \centering
    \includegraphics[width=11cm,height=10cm]{images/planoptimizationseq.png}
    \caption{Diagramme de séquence pour le scénario d'optimisation des plans d'abonnement}
\end{figure}
...
\end{figure}
\subsubsection{Interface d'optimisation des plans d'abonnement}
\noindent La figure 4.X présente l'interface des suggestions d'optimisation générées par le service NLP.

\begin{figure}[H]
    \centering
    \includegraphics[width=13cm,height=9cm]{images/planoptimizationinterface.PNG}
    \caption{Interface des suggestions d'optimisation des plans}
\end{figure}
...
\hline
Consulter les statistiques & En tant que Super Admin, je peux générer et exporter un rapport de performance au format PDF & Moyenne \\
\hline
\end{longtable} 
...
\begin{figure}[H] 
    \centering
    \includegraphics[width=13cm,height=8cm]{images/notificationsuc.png}
...
\begin{figure}[H]
    \centering 
    \includegraphics[width=14cm,height=8cm]{images/historyuc.png}
...
& 6. Le Super Admin peut générer un rapport PDF \\
& 7. Le système génère et télécharge le rapport PDF \\
\hline
\textbf{Scénario alternatif} & 
...
& - Génération de rapport PDF : disponible uniquement pour Super Admin \\
& - Aucune donnée : affichage d'un message approprié \\
\hline
\end{longtable}
\subsection{Conception}
\noindent Cette partie traite la seconde phase du sprint : conception détaillée du système. L’objectif est de créer des diagrammes de séquence illustrant les interactions entre acteurs et système.
