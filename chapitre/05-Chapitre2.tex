...
\noindent \textbf{Sécurité} : L'application doit protéger les données via une authentification unique, des sessions sécurisées, le hachage des mots de passe et des protocoles sûrs pour les données sensibles.

\noindent \textbf{Responsivité} : L'interface doit s’adapter à tout appareil pour une expérience fluide, selon les principes du Responsive Web Design et du CSS adaptatif.

\noindent \textbf{Performance} : L'application doit assurer une navigation rapide et un accès en temps réel aux tableaux de bord grâce à l’architecture React, même avec un grand volume de données.
\section{Backlog}
...
\hline
\endhead
1 & Authentification & En tant qu'utilisateur, je veux m'authentifier avec une adresse e-mail unique pour accéder à mes fonctionnalités. & Élevée \\
\cline{3-4}
& & En tant qu'utilisateur, je veux récupérer mon compte en cas d'oubli de mot de passe. & Moyenne \\
\hline
...
\hline
5 & Gérer les notifications & En tant qu'utilisateur, je veux consulter mes notifications pour rester informé des activités du système. & Moyenne \\
\hline
...
\hline
7 & Consulter les statistiques & En tant qu'utilisateur, je veux consulter les statistiques appropriées à mon rôle pour analyser les performances et la conformité. & Moyenne \\
\cline{3-4}
& & En tant que Super Admin, je peux générer et exporter un rapport de performance au format PDF. & Faible \\
\hline
...
\cline{3-4}
& & En tant qu'Admin, je veux consulter les paramètres de mon entreprise pour visualiser la configuration. & Moyenne \\
\cline{3-4}
...
\hline
12 & Souscrire aux abonnements & En tant qu'Admin, je veux consulter les plans d'abonnement disponibles pour évaluer les options. & Élevée \\
\cline{3-4}
& & En tant qu'Admin, je veux souscrire à un plan d'abonnement pour accéder aux fonctionnalités premium. & Élevée \\
\hline
13 & Gérer les plans d'abonnement & En tant que Super Admin, je veux créer des plans d'abonnement pour configurer les offres. & Moyenne \\
\cline{3-4}
...
\cline{3-4}
& & En tant que Super Admin, je peux consulter et appliquer les suggestions d'optimisation de plans. & Faible \\
\hline
14 & Consulter l'évaluation de conformité & En tant qu'Admin, je veux consulter l'évaluation de la conformité pour surveiller le respect des normes. & Élevée \\
\hline
15 & Gérer les plans d’action & En tant qu'Admin, je veux créer des plans d'action pour gérer les non-conformités. & Élevée \\
\cline{3-4}
...
\hline
16 & Consulter l'historique & En tant que Super Admin, je veux consulter l'historique complet des utilisateurs du site pour assurer la supervision. & Moyenne \\
\cline{3-4}
...
\hline
17 & Gérer la taxonomie & En tant que Super Admin, je veux créer des éléments de taxonomie pour organiser la classification du système. & Élevée \\
\cline{3-4}
...
\end{longtable}
\noindent Les priorités des user stories sont définies selon trois niveaux : Élevée pour les fonctionnalités essentielles qui constituent le socle de l'application et sans lesquelles elle ne peut fonctionner ; Moyenne pour les fonctionnalités importantes qui enrichissent l'expérience utilisateur et la gestion quotidienne mais dont l'absence n'empêche pas l'utilisation de base ; et Faible pour les fonctionnalités complémentaires qui apportent une valeur ajoutée sans être indispensables au fonctionnement ou à l'adoption de l'application.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=18cm,height=18cm]{images/diagramclass.png}
